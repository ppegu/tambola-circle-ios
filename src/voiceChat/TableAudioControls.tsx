        ...
        return (
          <Pressable
            ...
            accessibilityLabel={
              kind === "mic"
                ...
                : t(muted ? "Unmute all sound" : "Mute all sound")
            }
            accessibilityHint={
              kind === "mic" && error
                ? t("Voice unavailable. Tap the mic to retry.")
                : undefined
            }
            ...
            onPress={
              kind === "mic"
                ? () => {
                    requested.current = micMuted && !busy;
                    toggleTableMic();
                  }
                : toggleTableSpeaker
            }
          ...
          >
            <View style={styles.icon}>
              {kind === "mic" && busy ? (
                <ActivityIndicator size="small" color="#ffdf87" />
              ) : (
                <Svg
                  width={19}
                  height={19}
                ...
                >
                  {kind === "mic" ? (
                    <>
                      ...
                      <Path d="M6 10v2a6 6 0 0012 0v-2M12 18v3M9 21h6" />
                    </>
                  ) : (
                    <>
                      <Path d="M11 4L5 9H2v6h3l6 5z" />
                      <Path d="M15 8a6 6 0 010 8M18 5a10 10 0 010 14" />
                    </>
                  )}
                  {muted && (
                    <Path d="M3 3l18 18" stroke="#ff9ca8" strokeWidth={2.4} />
                  )}
                </Svg>
              )}
            </View>
