...
export function Icon({
  ...
  const paths: Record<string, string> = {
    ...
    "user-plus":
      "M3 28V25Q3 17 12 17Q21 17 21 25V28 M12 3a5 5 0 1 1 0 10a5 5 0 1 1 0-10 M26 8V20 M20 14H32",
    ...
    coins:
      "M4 15C4 10 21 10 21 15C21 20 4 20 4 15 M4 15V24C4 30 21 30 21 24V15 M4 20C4 25 21 25 21 20 M13 6C13 1 30 1 30 6C30 11 13 11 13 6 M13 6V10 M30 6V17Q28 20 24 20 M24 13Q29 13 30 10",
    ...
    palette:
      "M17 2C-4 2-3 30 17 30Q23 29 21 23Q18 18 27 18C35 17 31 2 17 2Z M10 9h.1 M19 7h.1 M26 11h.1 M7 18h.1",
    motion: "M8 7L19 16 8 25Z M19 7L30 16 19 25Z M2 2L30 30",
    board:
      "M4 3H11V10H4Z M15 3H22V10H15Z M26 3H33V10H26Z M4 14H11V21H4Z M15 14H22V21H15Z M26 14H33V21H26Z M4 25H11V32H4Z M15 25H22V32H15Z M26 25H33V32H26Z",
      ...
      {name === "sound" || name === "muted" ? (
        <>
          ...
          <Path
            d={
              name === "sound"
                ? "M22 10Q29 16 22 22 M27 5Q36 16 27 27"
                : "M23 12L30 21 M30 12L23 21"
            }
            stroke={color}
            strokeWidth={2.3}
            strokeLinecap="round"
