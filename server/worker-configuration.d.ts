/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70b2c2a8c7cf72b0ae4267e616a48fc1)
...
interface __BaseEnv_Env {
	...
	WEB_ASSETS: Fetcher;
	ALLOWED_ORIGINS: "http://localhost:8081,http://localhost:8082,http://127.0.0.1:8081";
	TEST_COIN_PURCHASES: "true";
	...
	TABLES: DurableObjectNamespace<import("./src/index").TableRoom>;
	VOICE_ROOMS: DurableObjectNamespace<import("./src/index").VoiceRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TableRoom" | "VoiceRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TEST_COIN_PURCHASES" | "MIGRATION_PAUSED" | "VOICE_ENABLED" | "AUTH_SECRET" | "UPDATE_SIGNING_KEY" | "UPDATE_ADMIN_TOKEN" | "UPDATE_KEY_ID" | "SFU_APP_ID" | "SFU_APP_SECRET" | "TURN_KEY_ID" | "TURN_API_TOKEN">> {}
}
