...
export const AVATAR_LABELS = [
  'Pink sari', 'Blue polo', 'Green blouse and glasses', 'Golden sari',
  'Yellow shirt and glasses', 'Teal shirt and moustache', 'Navy turban',
  'Blue blouse and curls', 'Red hoodie', 'Teal kurta and glasses',
  'Lavender scarf', 'Yellow shirt and ponytail', 'Purple polo', 'Coral blouse', 'Green kurta',
] as const;
