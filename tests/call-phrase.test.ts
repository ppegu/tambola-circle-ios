...
describe("digit then whole-number calls", () => {
  it.each([
    [23, "two three", "twenty three"],
    [10, "one zero", "ten"],
    [11, "one one", "eleven"],
    [70, "seven zero", "seventy"],
    [90, "nine zero", "ninety"],
    [7, null, "single number seven"],
    [9, null, "single number nine"],
    [1, null, "single number one"],
  ])("speaks %i in the requested order", (n, digits, full) => {
