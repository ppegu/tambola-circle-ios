...
import {
  ...
  LEGACY_API_ORIGIN,
  releaseForOrigin,
} from "../server/src/release-origin";
import type { ReleaseDescriptor } from "../shared/appAccess";
const path =
  "/download/android/files/com.ppegu.tambola/10/" + "a".repeat(64) + ".apk";
